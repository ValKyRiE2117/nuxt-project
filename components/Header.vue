          ...
          <li v-for="item in menuItems" :key="item.name">
            <a
              ...
              :class="[
                ...
                item.active
                  ? 'text-white bg-sky-500 md:bg-transparent md:text-sky-500 md:p-0 font-bold'
                  : 'text-gray-600 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-500 md:p-0',
              ]"
