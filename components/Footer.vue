        ...
        <div>
          ...
          <div class="space-y-3 mb-6">
            <p class="text-gray-400">
              <span class="font-medium">Email:</span> info@travelhub.com
            </p>
            <p class="text-gray-400">
          ...
          <div class="flex gap-4">
            <a
              ...
              class="w-10 h-10 flex items-center justify-center text-gray-400 hover:text-blue-400 transition-colors duration-200"
            >
